...
public interface FoodMapper {
    ...
    @Insert("INSERT INTO t_food(brand_name, food_name, cover_img, total_votes, safe_rate, " +
    ...
    @Update("UPDATE t_food SET cover_img = #{coverImg}, total_votes = #{totalVotes}, safe_rate = #{safeRate}, " +
